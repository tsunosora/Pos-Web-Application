...
export interface WaContactLite {
    ...
    optedOut: boolean;
    lead?: { id: number; name: string; status: string; source?: string; sourceDetail?: string | null; adId?: string | null; adCampaignName?: string | null; adLabel?: { id: number; name: string } | null } | null;
