...
describe('backup registry integrity', () => {
    ...
    it('tabel WhatsApp CRM terdaftar di backup & restore', () => {
        const waTables = ['waChannel', 'waContact', 'waConversation', 'waMessage', 'waWebhookEvent', 'waTemplate', 'waBroadcast', 'waBroadcastRecipient', 'waAutoReplyRule', 'waReminderConfig', 'waReminderLog'];
