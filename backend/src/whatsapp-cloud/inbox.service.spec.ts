...
const mediaStoreMock = () => ({
    persistFromMeta: jest.fn().mockResolvedValue(null),
    persistBuffer: jest.fn().mockResolvedValue(null),
...
describe('InboxService.ingestWebhook', () => {
    ...
    it('pesan pertama: buat kontak, percakapan (jendela 24 jam), & pesan masuk', async () => {
        ...
        const service = new InboxService(prisma as any, {} as any, autoReplyMock() as any, mediaStoreMock() as any, {} as any, { emitMessage() { }, emitConversation() { } } as any);
    ...
    it('memanggil auto-reply dgn konteks jendela terbuka', async () => {
        ...
        const service = new InboxService(prisma as any, {} as any, autoReply as any, mediaStoreMock() as any, {} as any, { emitMessage() { }, emitConversation() { } } as any);
...
describe('InboxService.replyText — guard jendela 24 jam', () => {
    ...
    it('mengirim teks & simpan OUTBOUND saat jendela masih terbuka', async () => {
        ...
        const service = new InboxService(prisma as any, cloud as any, autoReplyMock() as any, mediaStoreMock() as any, {} as any, { emitMessage() { }, emitConversation() { } } as any);
